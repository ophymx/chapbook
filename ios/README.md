...
publisher styles, theme, typeface, scoped to this book or to every book,
and a reset through `clearBookSettings`). The title bar shows *Return*
only while the engine's Back has somewhere to go. A long press selects
